...
private var _renderType : String;private var _mode : String;private var _type : String;private var commands : Array<Int> = new Array<Int>();private var drawingData : Array<Float> = new Array<Float>();private var _upperCornerBounds : Point = new Point(Float.MAX_VALUE, Float.MAX_VALUE);private var _lowerRightCornerBounds : Point = new Point(Float.MIN_VALUE, Float.MIN_VALUE);private var _objectDrawingMode : Bool = false;public function new()
    ...
    }  /**		* Type of Tool Option		*/  private function set_type(t : String) : String{_type = t;
        return t;
    }private function get_type() : String{return _type;
    }  /**		* Layer Tool Writes In		*/  private function get_layerType() : String{var layer : String;if (_objectDrawingMode) {layer = LayerType.OBJECT_LAYER;
        }
        else {layer = LayerType.DRAWING_LAYER;
        }return layer;
    }  /**		* Drawing Mode		*/  private function set_mode(toolMode : String) : String{  // store mode  if (toolMode != null && ToolMode.validMode(toolMode)) {_mode = toolMode;
        }
        else {_mode = ToolMode.NORMAL;
        }
        return toolMode;
    }private function get_mode() : String{return _mode;
    }  /**		* Object Drawing Mode		*/  private function set_objectDrawingMode(mode : Bool) : Bool{_objectDrawingMode = mode;
        return mode;
    }private function get_objectDrawingMode() : Bool{return _objectDrawingMode;
    }  /**		* The <code>resetTool</code> method will reset the drawing data held by the tool.		*/  public function resetTool() : Void{_upperCornerBounds.x = Float.MAX_VALUE;_upperCornerBounds.y = Float.MAX_VALUE;_lowerRightCornerBounds.x = Float.MIN_VALUE;_lowerRightCornerBounds.y = Float.MIN_VALUE;commands = new Array<Int>();drawingData = new Array<Float>();
