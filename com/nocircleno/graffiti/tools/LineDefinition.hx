...
class LineDefinition
{
	...
	*/  
	public function new(type : String, strokeColor : Int, strokeAlpha : Float, strokeSize : Float, lineWidth : Float, lineHeight : Float, commands : Vector<Int>, drawingData : Vector<Float>, position : Point)
    {
		// store properties  
		_type = type;
	...
	*/ 
	public function clone() : LineDefinition
	{
		return new LineDefinition(_type, _strokeColor, _strokeAlpha, _strokeSize, _lineWidth, _lineHeight, _commnads, _drawingData, _position);
    }
}