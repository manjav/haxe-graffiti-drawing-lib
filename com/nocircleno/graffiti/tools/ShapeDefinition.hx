...
private var _type : String;private var _strokeColor : Int;private var _fillColor : Int;private var _strokeAlpha : Float;private var _fillAlpha : Float;private var _strokeSize : Float;private var _position : Point;private var _shapeWidth : Float;private var _shapeHeight : Float;private var _commnads : Array<Int>;private var _drawingData : Array<Float>;  /**		* The <code>ShapeDefinition</code> constructor.		*		* @param type Type of shape.		* @param strokeColor Color of the shape stroke. Set to -1 for no stroke.		* @param fillColor Color of the shape fill. Set to -1 for no fill.		* @param strokeAlpha Alpha value of the shape stroke.		* @param fillAlpha Alpha value of the shape fill.		* @param strokeSize Size of the stroke.		* @param commands Commands used to draw the brush mark.		* @param drawingData Drawing data.		* @param position Position of the brush mark.		* 		*/ 		public function new(type : String, strokeColor : Int, fillColor : Int, strokeAlpha : Float, fillAlpha : Float, strokeSize : Float, shapeWidth : Float, shapeHeight : Float, commands : Array<Int>, drawingData : Array<Float>, position : Point)
    {
    ...
    } 	/**		* Width of the Shape		*/		private function set_width(value : Float) : Float{_shapeWidth = value;
        return value;
    }	private function get_width() : Float{return _shapeWidth;
    }  		/**		* Height of the Shape		*/		private function set_height(value : Float) : Float{_shapeHeight = value;
        return value;
        ...
        return value;
    }	/**		* The <code>clone</code> method will return a new instance of the ShapeDefinition.		*		* @return Returns new ShapeDefinition with all the same settings.		*/		public function clone() : ShapeDefinition{return new ShapeDefinition(_type, _strokeColor, _fillColor, _strokeAlpha, _fillAlpha, _strokeSize, _shapeWidth, _shapeHeight, _commnads, _drawingData, _position);
    }
}